    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-12">
                    <div class="mb-4">
                        <a href="<?= base_url('user/C_approval/v_reject'); ?>" class="btn-sm btn-outline-primary "><i class="fas fa-arrow-left">&nbsp;</i>Kembali</a>
                    </div>
                    <form action="<?= base_url('user/C_approval/update'); ?>" method="POST" enctype="multipart/form-data">
                        <!-- crsf -->
                        ...
                        <div class="text-right">
                            <button type="submit" class="btn-sm btn-success mt-3">Revisi</button>
                            <!-- <a href="<?= base_url('user/C_transaksi/complate/' . $transaksi_mess->id_trx_mess); ?> " class="btn-sm btn-success p-2 text-decoration-none" onclick="return confirm('Apakah anda yakin?')"><i class="fas fa-check">&nbsp;</i>Complate</a> -->
                        </div>
                    </form>
                </div>
            </div>
