        ...
        <div class="card-body">
            <div class="row">
                <div class="col-12">
                    ...
                    <form action="<?= base_url('admin/C_departemen/save'); ?>" method="POST" enctype="multipart/form-data">
                        <!-- crsf -->
                        <!-- <div class="row"> -->
                        <div class="col-sm-6">
                            <label for="nama_departemen" class="col-form-label">Nama Departemen</label>
                            <input type="text" class="form-control text-capitalize" id="nama_departemen" name="nama_departemen" autofocus required>
                        </div>
                        <div class="col-sm-6">
                            <label for="singkatan_departemen" class="col-form-label">Nama Singkatan</label>
                            <input type="text" class="form-control text-uppercase" id="singkatan_departemen" name="singkatan_departemen" autofocus required>
                        </div>
                        <!-- </div> -->
                        <hr class="mt-4">
