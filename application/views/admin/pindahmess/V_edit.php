    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-12">
                    <div class="mb-4">
                        <a href="<?= base_url('admin/C_pindahmess/index'); ?>" class="btn-sm btn-outline-primary "><i class="fas fa-arrow-left">&nbsp;</i>Kembali</a>
                    </div>
                    <form action="<?= base_url('admin/C_pindahmess/update'); ?>" method="POST" enctype="multipart/form-data">
                        <!-- crsf -->
